...
# Save results
if(st.interac=="TypeII") {
  save(types.inla, file = "icar_typeII_model_h1_inla.Rdata")
}

if(st.interac=="TypeIII") {
  save(types.inla, file = "icar_typeIII_model_h1_inla.Rdata")
}

if(st.interac=="TypeIV") {
  save(types.inla, file = "icar_typeIV_model_h1_inla.Rdata")
}
