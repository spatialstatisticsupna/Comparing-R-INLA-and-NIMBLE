...
## 6. Save results ##
save(result.nimble, file = "icar_typeI_model_h1_nimble2.Rdata")
...
## 6. Save results ##
save(result.nimble, file = "icar_typeII_model_h1_nimble2.Rdata")
...
## 6. Save results ##
save(result.nimble, file = "icar_typeIII_model_h1_nimble2.Rdata")
...
## 6. Save results ##
save(result.nimble, file = "icar_typeIV_model_h1_nimble2.Rdata")
