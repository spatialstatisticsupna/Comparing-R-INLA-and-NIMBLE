...
source("icar_models/icar_h1_nimble2.R")
...
typeI.nimble2 <- runMCMC(cMCMC, niter = num.iter, nburnin = num.burnin, 
                         nchains = num.chains, thin = num.thin, 
                         samplesAsCodaMCMC = TRUE, summary=TRUE, WAIC = TRUE)

## 6. Save results ##
save(typeI.nimble2, file = "icar_typeI_model_h1_nimble2.Rdata")
...
## 5. Obtain the samples ##
typeII.nimble2 <- runMCMC(cMCMC, niter = num.iter, nburnin = num.burnin, 
                         nchains = num.chains, thin = num.thin, 
                         samplesAsCodaMCMC = TRUE, summary=TRUE, WAIC = TRUE)

## 6. Save results ##
save(typeII.nimble2, file = "icar_typeII_model_h1_nimble2.Rdata")
...
## 5. Obtain the samples ##
typeIII.nimble2 <- runMCMC(cMCMC, niter = num.iter, nburnin = num.burnin, 
                         nchains = num.chains, thin = num.thin, 
                         samplesAsCodaMCMC = TRUE, summary=TRUE, WAIC = TRUE)
 
## 6. Save results ##
save(typeIII.nimble2, file = "icar_typeIII_model_h1_nimble2.Rdata")
...
## 5. Obtain the samples ##
typeIV.nimble2 <- runMCMC(cMCMC, niter = num.iter, nburnin = num.burnin, 
                         nchains = num.chains, thin = num.thin, 
                         samplesAsCodaMCMC = TRUE, summary=TRUE, WAIC = TRUE)

## 6. Save results ##
save(typeIV.nimble2, file = "icar_typeIV_model_h1_nimble2.Rdata")
