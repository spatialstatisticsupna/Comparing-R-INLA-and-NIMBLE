...
# ------       Spanish breast cancer data - NIMBLE 1 and NIMBLE 2      ------ #
...
# H1 hyperpriors
source("bym_models/bym_h1_nimble1.R")   # Nimble 1
source("bym_models/bym_h1_nimble2.R")   # Nimble 2
...
## 6. Save results ##
save(result.nimble, file = "bym_typeIII_model_h1_nimble1.Rdata")
