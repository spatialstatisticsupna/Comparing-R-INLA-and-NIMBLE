...
if(st.interac=="TypeI") {
  ...
  ## 6. Save results ##
  save(typeI.nimble2, file = "bym_typeI_model_h1_nimble2.Rdata")
}
...
if(st.interac=="TypeII") {
  ...
  ### 6. Save results ###
  save(typeII.nimble2, file = "bym_typeII_model_h1_nimble2.Rdata")
}
...
if(st.interac=="TypeIII") {
  ...
  ## 6. Save results ##
  save(typeIII.nimble2, file = "bym_typeIII_model_h1_nimble2.Rdata")
...
if(st.interac=="TypeIV") {
  ...
  ## 6. Save results ##
  save(typeIV.nimble2, file = "bym_typeIV_model_h1_nimble2.Rdata")
