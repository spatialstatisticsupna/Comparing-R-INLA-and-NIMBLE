...
## 6. Save results ##
save(typeI.nimble1, file = "icar_typeI_model_h1_nimble1.Rdata")
...
## 6. Save results ##
save(typeII.nimble1, file = "icar_typeII_model_h1_nimble1.Rdata")
...
## 6. Save results ##
save(typeIII.nimble1, file = "icar_typeIII_model_h1_nimble1.Rdata")
...
## 6. Save results ##
save(typeIV.nimble1, file = "icar_typeIV_model_h1_nimble1.Rdata")
