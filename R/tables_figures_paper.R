...
# Araba
plot(range(x),c(0.7,1.3),type="n",xlab="",ylab=expression(exp(delta[it])), xaxt="n", main="?LAVA", 
...
# Gipuzkoa
plot(range(x),c(0.7,1.3),type="n",xlab="",ylab=expression(exp(delta[it])), xaxt="n", main="GIP?ZCOA", 
     cex.lab=1.3, cex.axis=1.4, cex.main=1.5, cex.sub=1.5)
axis(1, at=seq(1,t,5), labels=seq(t.from,t.to,5), las=0)
...
# CIUDAD REAL, C?RDOBA, GRANADA, JA?N
par(mfrow=c(1,4), mar=c(5.1, 4.5, 4.1, 2.1))
# Ciudad Real
...
# C?rdoba
plot(range(x),c(0.7,1.3),type="n",xlab="",ylab=expression(exp(delta[it])), xaxt="n", main="C?RDOBA", 
     cex.lab=1.3, cex.axis=1.4, cex.main=1.5, cex.sub=1.5)
axis(1, at=seq(1,t,5), labels=seq(t.from,t.to,5), las=0)
...
# Ja?n
plot(range(x),c(0.7,1.3),type="n",xlab="",ylab=expression(exp(delta[it])), xaxt="n", main="JA?N", 
     cex.lab=1.3, cex.axis=1.4, cex.main=1.5, cex.sub=1.5)
axis(1, at=seq(1,t,5), labels=seq(t.from,t.to,5), las=0)
