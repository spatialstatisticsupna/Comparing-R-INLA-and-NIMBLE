...
## References
	[Urdangarin, A., Goicoa, T., and Ugarte, M.D. (2022). Space-time interactions in Bayesian disease mapping with recent tools: making things easier for practitioners. Submitted to __Statistical Methods in Medical Research__, in press.]  (https://doi.org/10.1177/10.1177/096228022210793519).
